$(document).ready(function () {
    ...
    $.getJSON(url, function (data) {
        ...
        $('.read').on('click', function () {
            ...
            $('.tweetQuote').attr('href', 'https://twitter.com/intent/tweet?text=' + currentQuote.title + ' By- ' + currentQuote.author).attr('target', '_blank').removeClass('disabled');
            $('.read').html('Show one more');
        });
    });
});